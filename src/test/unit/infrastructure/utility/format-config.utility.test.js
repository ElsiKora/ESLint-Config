...
const MOCK_PATH = "../../../../infrastructure/constant/utility/plugin-map.constant";
describe("FormatConfigUtility", () => {
    ...
    it("should remap plugin names based on PLUGIN_MAP entries", async () => {
        ...
        const module = await import("../../../../infrastructure/utility/format-config.utility");
        const formatConfig = module.formatConfig.bind(module);
    ...
    it("should handle multiple configs with different rule formats", async () => {
        ...
        const module = await import("../../../../infrastructure/utility/format-config.utility");
        const formatConfig = module.formatConfig.bind(module);
        const result = formatConfig(mockConfigs);
        expect(result).toEqual([
            {
                rules: {
                    "typescript/no-explicit-any": "error",
