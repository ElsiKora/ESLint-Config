...
import jsx from "eslint-plugin-jsx-a11y-x";
...
export default function loadConfig(): Array<Linter.Config> {
	return [formatConfig([jsx.configs.recommended])[0], { files: ["*.tsx", "**/*.tsx", "*.jsx", "**/*.jsx"], rules: { [formatRuleName("jsx-a11y-x/no-autofocus")]: "off" } }] as Array<Linter.Config>;
}
